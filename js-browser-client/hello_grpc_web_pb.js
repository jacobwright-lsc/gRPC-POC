 ...
 * @final
 */
proto.hello.HelloerPromiseClient =
    function(hostname, credentials, options) {
  if (!options) options = {};
  options.format = 'text';
 ...
 */
const methodDescriptor_Helloer_SayHello = new grpc.web.MethodDescriptor(
  '/hello.Helloer/SayHello',
 ...
 */
proto.hello.HelloerClient.prototype.sayHello =
    function(request, metadata, callback) {
  return this.client_.rpcCall(this.hostname_ +
      '/hello.Helloer/SayHello',
      request,
      metadata || {},
      methodDescriptor_Helloer_SayHello,
      callback);
};
 ...
 */
proto.hello.HelloerPromiseClient.prototype.sayHello =
